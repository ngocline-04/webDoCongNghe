...
$SMTPAuth = true;
$userMail = 'hthu19082004@gmail.com'; 
$userPassword = 'ojdn qltn mvwu mcfh';   
$mailPort       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
