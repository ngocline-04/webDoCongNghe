<?php if (Auth::loggedIn('user') && Auth::getUser('user')['role_id'] == 1) : ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Allaia 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class="btn btn-primary" href="<?php echo url('admin/login/logout') ?>">Đăng xuất</a>
                </div>
            </div>
        </div>
    </div>
